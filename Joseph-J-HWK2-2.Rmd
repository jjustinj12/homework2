...
### 8
All these different estimator provide a different estimate of the average treatment effect. My prediction for this is because they are using different frameworks in finding observations that are similar both between the control and treatment groups. 

### 9
I did not estimate a  causual because i was unable to correctly complete the ATE estimates
